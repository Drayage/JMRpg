...
export const skills = {
  ...
  iron_skin: { id: "iron_skin", type: "passive", apCost: 1, tags: ["defensive", "frontline"], passiveStats: { HP: 10, PD: 3 } },
  aura_cut: { id: "aura_cut", type: "active", apCost: 2, chance: 0.52, scalingStat: "MA", tags: ["holy", "weapon", "magic"], effects: [damage("MA", 1.35), guard(3)] },
  curse_mark: { id: "curse_mark", type: "active", apCost: 2, chance: 0.5, scalingStat: "MA", tags: ["dark", "critical"], effects: [damage("MA", 1.45, { critBonus: 10 })] },
  ...
  plague_cloud: { id: "plague_cloud", type: "special", apCost: 3, chance: 0.42, scalingStat: "MA", tags: ["poison", "magic"], effects: [damage("MA", 1.1), poison(10, 4)] },
  ...
  starfall: { id: "starfall", type: "special", apCost: 4, chance: 0.34, scalingStat: "MA", tags: ["holy", "magic"], effects: [damage("MA", 2.55)] },
  ...
  trail_grit: { id: "trail_grit", type: "passive", apCost: 1, tags: ["foundation", "survival", "utility"], passiveStats: { HP: 12, PD: 2, MD: 1 } },
  emergency_bandage: { id: "emergency_bandage", type: "special", apCost: 2, chance: 0.44, priority: true, condition: { type: "hp_below", value: 0.5 }, scalingStat: "HP", tags: ["survival", "support"], effects: [heal("HP", 0.18), guard(5)] },
  ...
  palm_break: { id: "palm_break", type: "active", apCost: 1, chance: 0.56, scalingStat: "PA", tags: ["physical", "martial"], effects: [damage("PA", 1.35), guard(2)] },
  flowing_form: { id: "flowing_form", type: "passive", apCost: 2, tags: ["martial", "speed", "defensive"], passiveStats: { SPD: 3, EVA: 3, PD: 2 } },
  pinning_bolt: { id: "pinning_bolt", type: "active", apCost: 2, chance: 0.5, scalingStat: "ACC", tags: ["ranged", "critical", "utility"], effects: [damage("ACC", 0.5), guard(4)] },
  ...
  spirit_talisman: { id: "spirit_talisman", type: "passive", apCost: 2, tags: ["spirit", "magic", "support"], passiveStats: { MA: 3, MD: 3, SPD: 1 } },
  time_charm: { id: "time_charm", type: "special", apCost: 3, chance: 0.4, priority: true, condition: { type: "hp_below", value: 0.7 }, scalingStat: "MD", tags: ["time", "spirit", "defensive"], effects: [heal("MD", 1.2), guard(8)] },
  ...
  meridian_burst: { id: "meridian_burst", type: "special", apCost: 3, chance: 0.38, priority: true, condition: { type: "enemy_hp_below", value: 0.55 }, scalingStat: "SPD", tags: ["martial", "critical"], effects: [damage("SPD", 2.25, { critBonus: 18 })] },
  ...
  feast_of_omens: { id: "feast_of_omens", type: "special", apCost: 3, chance: 0.36, priority: true, condition: { type: "hp_below", value: 0.6 }, scalingStat: "HP", tags: ["food", "risk", "support"], effects: [heal("HP", 0.22), damage("PA", 1.1)] }
};
