...
export const skills = {
  ...
  shield_bash: { id: "shield_bash", type: "active", apCost: 1, chance: 0.5, scalingStat: "PD", tags: ["physical", "defensive", "frontline"], effects: [damage("PD", 1.35), guard(4), status("staggered", "foe", 1, { statMods: { PA: -3, ACC: -5 } })] },
  ...
  marked_shot: { id: "marked_shot", type: "active", apCost: 2, chance: 0.5, scalingStat: "ACC", tags: ["physical", "ranged", "critical"], effects: [damage("ACC", 0.56, { critBonus: 8 }), status("marked", "foe", 2, { damageTakenMultiplier: 1.1, statMods: { EVA: -4 } })] },
  ...
  time_barrage: { id: "time_barrage", type: "special", apCost: 3, chance: 0.55, maxUses: 1, priority: true, condition: { type: "enemy_hp_above", value: 0.45 }, scalingStat: "ACC", tags: ["ranged", "time", "critical"], effects: [damage("ACC", 1.08, { critBonus: 24 }), guard(4), status("time_slow", "foe", 2, { statMods: { SPD: -5, EVA: -4 } })] },
  clockwork_sight: { id: "clockwork_sight", type: "special", apCost: 2, chance: 0.74, maxUses: 1, priority: true, tags: ["ranged", "time", "utility", "focus"], scalingStat: "ACC", effects: [status("clockwork_sight", "self", 999, { permanent: true, statMods: { ACC: 6, CRT: 5, CRD: 10 } })] },
  ...
  final_course: { id: "final_course", type: "special", apCost: 3, chance: 0.36, priority: true, condition: { type: "enemy_hp_below", value: 0.55 }, scalingStat: "HP", tags: ["food", "risk", "critical"], effects: [damage("HP", 0.34, { critBonus: 18 }), heal("HP", 0.12)] },
  lucky_leftovers: { id: "lucky_leftovers", type: "passive", apCost: 2, tags: ["food", "risk", "support"], passiveStats: { HP: 16, CRT: 3, CRD: 10 } }
};
